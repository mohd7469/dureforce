...
class SkillCategoryController extends Controller
{
    ...
    {
        try {
            $pageTitle = "Skill Categories List";
    ...
    public function create()
    {
        try {
            ...
            $pageTitle = "Create Skill Category";
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $notify[] = ['success', 'Your Skill Category detail has been Created.'];
    ...
    public function editdetails($id)
    {
        try {
            ...
            $pageTitle = "Manage All Skill Categories Details";
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            Log::info(["skillCategory" => $skill_categories]);
            $notify[] = ['success', 'Skill Category detail has been updated'];
            return redirect()->route('admin.skill.category.index')->withNotify($notify);
        }
        catch (\Exception $exp) {
            DB::rollback();
    ...
    public function delete($id)
    {
        ...
        $notify[] = ['success', 'Skill Category deleted successfully'];
        return back()->withNotify($notify);
        }
        catch (\Exception $exp) {
            DB::rollback();
