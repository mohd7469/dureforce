...
//            Route::get('tickets/view/{id}', 'SupportTicketController@ticketReply')->name('ticket.view');
            ...
            Route::post('ticket-status-change/{status_id}', 'SupportTicketController@changeSattus')->name('ticket.status.change');
            Route::post('ticket-priority-change/{status_id}', 'SupportTicketController@changePriority')->name('ticket.priority.change');
