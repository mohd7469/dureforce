    ...
    <section class="account-section ptb-80 bg-overlay-white bg_img ">
        <div class="container">
            <div class="verify-main text-center">
                ...
                <h2 class="mb-4">Verify your email to proceed</h2>
                <p>We just send an email to address: {{ auth()->user()->email ?? '-' }}<br />Please check your email and
                    click on the link provided to verify your address</p>
                ...
                <a href="{{ url('/register') }}">resend COde</a>
            </div>
        </div>
    </section>
@endsection
