                ...
                <div class="flex-md-row mb-4 box-shadow h-md-250 text-center" >
                  <div class="pt-4-left mx-auto">
                    <img src="/assets/images/job/f-icon.png" alt="icon">
                      ...
                      <div class="mt-4">
                        <p class="text-dark-heading">Offer Has Been Sent To {{$email_data['offer']->module->user->fullname}}</p>
                      </div>
                      <div class="mb-2 mt-1">
                        <p class="text-dark">We’ll notify you when {{$email_data['offer']->module->user->fullname}} will respond
            ...
            <div class="col-md-8">
                <div class="flex-md-row mb-4 box-shadow h-md-250">
                    <div class="d-flex flex-column align-items-start pright-spacing ">
                      ...
                      <h4 class="heading">
                        Are you done Hiring for the job "{{$email_data['offer']->module->title}}?"
                      </h4>
                      <div class="p-3">
