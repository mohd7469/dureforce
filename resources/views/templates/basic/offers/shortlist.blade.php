                        ...
                        <div class="">
                            <div class="row">
                                <ul class="offerlisting">
                                    <li><a href="#">All Proposal <span></span></a></li>
                                    <li><a href="#">Shortlisted <span>(3)</span></a></li>
                                    <li><a href="#">Message<span>(2)</span></a></li>
                                </ul>
                                           ...
                                           <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <a href="#" class="btn-products-2s">Remove</a>
                                                    <a href="#" class="btn-products-2s">View Profile</a>
                                                   
                                                    {{-- <a href="#" class="btn-products-2s">Hire</a> --}}
                                                    <a href="#" class="btn-products-2s phire">Hire</a>
