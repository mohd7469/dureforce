<html lang="en">
    ...
    <form action="https://azapp-dureforce-dev.azurewebsites.net/user/seller/profile/save-payment-methods" method="POST">
        <input type="hidden" name="_token" value="bNpyRs3QyOnT5UorUY5izFnvouKTq47tM6AHF2tp">        <div class="container-fluid welcome-body">
            ...
            <span class="cmnt col-md-12 pb-2">
                <div class="row">
                    <div class="col-md-7">
                        <span>Add or delete payment methods for your account.</span>
                    </div>
                    <div class="col-md-5 text-center">
                            <a href="#" class="submit-btn text-decoration-none float-end">Add a Payment Method</a>
                    </div>
                </div>
                </span>
            
            <div class="">
                <div class="row mt-20" id="" style="
                            background: #DDF2F2;
                            border: 2px solid #007F7F;
                            border-radius: 6px;
                            padding: 20 20 0 20;
                        ">
                    <div class="col-xl-4 col-md-3 col-lg-3 form-group mt-1">
                    <img src="https://cdn4.iconfinder.com/data/icons/flat-brand-logo-2/512/visa-512.png" heigh=40 width=40 alt="">
                        <span>Visa-2394</span>
                    </div>
                    <div class="col-xl-3 col-md-3 col-lg-3 form-group mt-2">
                        <span>Expiry: 4 / 2025</span>
                    </div>
                    <div class="col-xl-3 col-md-3 col-lg-3 form-group mt-2">
                        <span>Primary</span>
                    </div>
                    <div class="col-xl-2 col-md-3 col-lg-3 form-group">
                    </div>
                </div>
                <div class="row mt-20" id="" style="
                            background: #EFF4F4;
                        ...
                        ">
                    <div class="col-xl-4 col-md-3 col-lg-3 form-group mt-1">
                    <img src="https://purepng.com/public/uploads/large/purepng.com-mastercard-logologobrand-logoiconslogos-251519938372dnf77.png" heigh=40 width=40 alt="">
                        <span>MasterCard-5932</span>
                    </div>
                    <div class="col-xl-3 col-md-3 col-lg-3 form-group mt-2">
                        <span>Expiry: 6 / 2024</span>
                    </div>
