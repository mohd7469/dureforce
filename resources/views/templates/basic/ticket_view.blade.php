                                                ...
                                                <div
                                                    ...
                                                    <h4 class="card-title text-lowercase mb-0">
                                                        @if ($my_ticket->status == 0)
                                                            <span
                                                                class="badge badge--success text-capitalize text-white">@lang('Open')</span>
                                                        @elseif($my_ticket->status == 1)
                                                            <span
                                                                class="badge badge--primary text-capitalize text-white">@lang('Answered')</span>
                                                        @elseif($my_ticket->status == 2)
                                                            <span
                                                                class="badge badge--warning text-capitalize text-white">@lang('Replied')</span>
                                                        @elseif($my_ticket->status == 3)
                                                            <span
                                                                class="badge badge--danger text-capitalize text-white">@lang('Closed')</span>
                                                        @endif
                                                        [@lang('Ticket')#{{ $my_ticket->ticket }}]
                                                        {{ $my_ticket->subject }}
                                                    </h4>
                                                    <div class="card-btn">
                                                        <button
                                                            class="btn btn--danger text-white border--rounded close-button"
                                                            type="button" title="Close Ticket" data-bs-toggle="modal"
                                                ...
                                                <div class="card-body">
                                                    <div class="card-form-wrapper">
                                                        @if ($my_ticket->status != 4)
                                                            <form action="{{ route('ticket.reply', $my_ticket->id) }}"
                                                                method="post" role="form" enctype="multipart/form-data">
                                                                @csrf
                                                                <input type="hidden" name="replayTicket" value="1">
                                                                <div class="row justify-content-center mb-20-none">
                                                                    <div class="col-xl-12 col-lg-12 form-group">
                                                                        <textarea class="form-control bg--gray" name="message" rows="8" placeholder="@lang('Your Reply') ..."
                                                                            required=""></textarea>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="row justify-content-between">
                                                                            <div class="col-md-11">
                                                                                <div class="form-group">
                                                                                    <div
                                                                                        class="input-group ticket-input-group">
                                                                                        <div class="input-group-prepend">
                                                                                            <span
                                                                                                class="input-group-text text-white"
                                                                                                id="inputGroupFileAddon01">@lang('Upload')</span>
                                                                                        </div>
                                                                                        <div class="custom-file">
                                                                                            ...
                                                                                            <label class="custom-file-label"
                                                                                                for="inputGroupFile01">@lang('Choose
                                                                                                file')</label>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <p
                                                                                        class="my-2 ticket-attachments-message">
                                                                                        @lang('Allowed File Extensions'):
                                                                                        .@lang('jpg'), .@lang('jpeg'),
                                                                                        .@lang('png'),
                                                        ...
                                                        @foreach ($messages as $message)
                                                            @if ($message->admin_id == 0)
                                                                <div
                                                                    class="row border--success border--rounded my-3 py-3 mx-2">
