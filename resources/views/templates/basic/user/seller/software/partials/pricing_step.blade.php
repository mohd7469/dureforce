                ...
                <div class="col-xl-12 col-lg-12 form-group p-0">
                            ...
                            <div class="row add-ons">
                                ...
                                <div class="col-xl-4 col-lg-4 form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control add-on-delivery" id="add_on_delivery"
                            ...
                            <div id="add-service-container">
                                ...
                                <div class="row add-ons" id="add-on-service-row-{{ $exKey }}">
                                    ...
                                    <div class="col-xl-4 col-lg-4 form-group">
                                        ...
                                        <input type="number" class="form-control add_on_price"
                    ...
                    <div class="col-xl-12 col-lg-12 form-group p-0">
                            ...
                            <div id="add-service-custom-container">
                                <div class="row add-ons">
                                    ...
                                    <div class="col-xl-4 col-lg-4 form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" class="form-control add-on-delivery"
                                                   id="add_on_delivery" name="add_on_delivery[]"
                                                   placeholder="@lang('Enter Hours')">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                <button class="btn btn-primary" id="add-more-customservice" type="button">Add Another
                                </button>
                            </div>
                        </div>
