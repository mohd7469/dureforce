            ...
            <div class="section-wrapper">
                <div class="row justify-content-center mb-30-none">
                    ...
                    <div class="col-xl-9 col-lg-12 mb-30">
                        ...
                        <form class="user-profile-form" action="{{route('user.service.update', $service->id)}}"
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6 form-group">
                                                <div class="card custom--card p-0 mb-3">
                                                    ...
                                                    <div class="p-2">
                                                        ...
                                                        <input required="" type="text" name="banner_heading"
                                                               maxlength="255"
                                                               value="{{__($service->banner_heading)}}"
                                                               class="form-control"
                                                               placeholder="@lang("Enter  Banner Heading")" required="">
                                                        <label>@lang('Banner Detail')*</label>
                                                        <textarea required="" type="text" name="banner_detail"
                                                                  maxlength="255"
                                                                  class="form-control"
                                                                  placeholder="@lang("Enter Banner Detail")"
                                                                  required="">{{__($service->banner_detail)}}
                                                        </textarea>
                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 form-group">
                                                ...
                                                <input type="text" name="title" maxlength="255"
                                                       value="{{__($service->title)}}" class="form-control"
                                            ...
                                            <div class="col-xl-6 col-lg-6 form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <span class="input-group-text"
                                                          id="basic-addon2">@lang('Days')</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card custom--card p-0 mb-3">
                                                <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
                                                    ...
                                                    <div class="card-btn">
                                                        <button type="button" class="btn--base addExtra"><i
                                                            ...
                                                            @foreach($service->extraService as $extrservice)
                                                                <div class="col-lg-12 extraServiceRemove">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-2 col-lg-12 form-group">
                                                                            <div class="input-group mb-3">
                                                                                <input type="text" class="form-control"
                                                                                       name="extra_price[]"
                                                                                       value="{{getAmount($extrservice->price)}}"
                                                                                       required="">
                                                                                <span class="input-group-text"
                                                                                      id="basic-addon2">{{__($general->cur_text)}}</span>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-xl-1">
                                                                            <button type="button"
                                                                                    class="btn btn--danger text-white border--rounded btn-sm mt-1 removeBtn">
                                            ...
                                            <div class="col-xl-12 col-lg-12 form-group">
                                                ...
                                                <textarea class="form-control bg--gray nicEdit"
                                                          name="description">@php echo $service->description @endphp</textarea>
                                            </div>
                                            <div class="col-xl-12 form-group">
                                                <button type="submit"
                                                        class="submit-btn mt-20 w-100">@lang("Update Service")</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
