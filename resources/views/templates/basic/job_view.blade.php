            ...
            <div class="col-xl-9 col-lg-9 mb-30">
               <div class="item-details-thumb-area mt-0">
                  <div class="item-details-footer">
                     <div class="left mb20">
                        <h3 class="title"> {{$job->title? $job->title : '' }}</h3>
                     </div>
                           ...
                           <ul class="right-item">
                              ...
                              <li>
                                 <a href="http://twitter.com/share?url={{ Request::url()}}"
                                    target="__blank">{{$job->status->name ? $job->status->name : '' }}</a>
                              </li>
                              <li class="right-text">
                                 Posted on:
                              </li>
                              <li> {{$job->created_at->format('Y-m-d') ? $job->created_at->format('Y-m-d') : '' }} </li>
                           </ul>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="job_subtitle2   dod-text">
                     <h4> Deliverables</h4>
                  ...
                  <div class="job_subtitle2 Attachments">
                     <h4>Attachments</h4>
                     <ul>
                  ...
                  <br/>   
                  <div class="job_subtitle2 attributes">
                  ...
                  <div class="row custom_cards_s">
                     <h4 class="d-heading">Programming Language</h4>
                     <div class="col-md-6">
                        <div class="card" >
                           <div class="card-body">
                              <h5 class="card-title">Backend</h5>
                  ...
                  <div class="row custom_cards_s">
                     <h4 class="d-heading">Coding Competence</h4>
                     <div class="col-md-6">
                        <div class="card" >
                           <div class="card-body">
                              <h5 class="card-title">Backend</h5>
                  ...
                  <div class="row custom_cards_s">
                     <h4 class="d-heading">Database</h4>
                     <div class="col-md-6">
                        <div class="card" >
                           <div class="card-body">
                              <h5 class="card-title">Backend</h5>
               ...
               <div class="sidebar">
                  <div class="widget custom-widget mb-30">
                     <ul class="sidebar-title1">
                        <li><span>Fixed Price</span>
                           <span>{{$job->fixed_amount}}</span>
                        </li>
                     </ul>
                     <ul class="sidebar-list">
                        <li><span class="side_head">@lang('Resource Location')</span>
                           <span>{{$job->country->name ? $job->country->name : '' }}</span>
                        </li>
                        <li><span class="side_head">Budget Type</span>
                           <span>{{$job->budgetType->title ? $job->budgetType->title : ''}}</span>
                        </li>
                        <li><span class="side_head">Est. Project Duration</span>
                           <span>{{$job->project_length->name}}</span>
                        </li>
                        <li><span class="side_head">Project Start Date:</span>
                           <span>{{$job->expected_start_date ? $job->expected_start_date  : ''}}</span>
                        </li>
                        <li><span class="side_head">Project Stage</span>
                           <span>{{$job->projectStage->title ? $job->projectStage->title  : ''}}</span>
                        </li>
                        <li><span class="side_head">Experience Level</span>
                           <span>{{$job->rank->level ? $job->rank->level  : ''}}</span>
                        </li>
                     </ul>
                     <div class="widget-btn- mt-20">
                        <a href="javascript:void(0)" data-bs-toggle="modal"
                           data-bs-target="#depoModal" class="standard-btn ">@lang('Submit Prosposals')</a>
                        <a href="javascript:void(0)" data-bs-toggle="modal"
...
<div class="col-md-9 col-sm-19 text-center">
   ...
   <div class="location">
      <ul>
         <li><i class="fa fa-map-marker" aria-hidden="true"></i>{{json_encode($job->user->address->address) ? json_encode($job->user->address->address)  : ''}}</li>
   ...
   <ul class="sidebar-title-custom">
      <li>
            <span>22</span> <span> Jobs posted</span></li>
      <li><span>05</span><span>  Open jobs</span></li>
</ul>
   <div class="sep-solid"></div>
   <div class="mb-3">
