                                            ...
                                            @foreach ($subCategorys as $subCategory)
                                                <div class="swiper-slide">
                                                    <div class="category-item-box">
                                                        <a
                                                            href="{{ route('software.sub.category', [slug($subCategory->name), encrypt($subCategory->id)]) }}">
                                    ...
                                    <div class="item-wrapper d-flex flex-wrap justify-content-between align-items-center">
                                            ...
                                            <div class="item-value">
                                                <span>
                                                    @if ($softwares->count() > 0)
                                                        @lang('Showing item'):&nbsp
                                                        <span class="result">{{ $softwares->count() }} of
                                                            {{ $softwares->count() }}</span>
                                                    @else
                                                        <span class="result">There is no Item</span>
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                                        <ul class="view-btn-list">
                                            ...
                                            <li class="active"><button type="button"
                                                    class="list-view-btn list-btn"><i class="las la-list"></i></button>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="col-xl-9 col-lg-9 mb-30">
                                            <div class="item-card-wrapper custom-card-wrapper grid-view">
                                                @forelse($softwares as $software)
                                                    <div class="item-card" style="min-width: 280px;">
                                                            ...
                                                            <div class="right">
                                                                <div class="order-btn">
                                                                    <a href="{{ $software->demo_url }}" target="__blank"
                                                                        class="btn--base"><i
                                                                            class="las la-desktop"></i> @lang('Preview')</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
