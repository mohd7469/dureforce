                        ...
                        type="checkbox" name="educations[`+edu_row_index+`][is_enrolled]" /> I’m currently enroll here
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="educations[`+edu_row_index+`][start_date]" onchange="setMinDateInsti($(this), $('.end-date-insti'))" min="1900-01-01" max="2099-12-31">
                                                    
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="" class="mt-4">To Date <span class="imp">*</span></label>
                                                    <input type="date" class="end-date-insti" name="educations[`+edu_row_index+`][start_date_job]" onchange="checkIfDateGreaterInsti($(this))" min="1900-01-01" max="2099-12-31">
                                                </div>
