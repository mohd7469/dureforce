                ...
                <div id="experiance-row-`+edu_row_index+`">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="educations[`+edu_row_index+`][start_date]" onchange="setMinDateInsti($(this), $('.end-date-job-educatin-`+edu_row_index+`'))" min="1970-01-01">
                                                    
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="" class="mt-4">To Date <span class="imp">*</span></label>
                                                    <input type="date" class="end-date-job-educatin-`+edu_row_index+`" name="educations[`+edu_row_index+`][end_date]" onchange="checkIfDateGreaterInsti($(this))" min="1970-01-01">
                                                </div>
