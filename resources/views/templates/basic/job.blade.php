                                                ...
                                                @forelse($jobs as $job)
                                                    <div class="item-card">
                                                        <div class="item-card-thumb">
                                                            <a
                                                                href="{{ route('job.details', [slug($job->title), encrypt($job->id)]) }}">

                                                                @include(
                                                                    $activeTemplate . 'partials._banner-listing',
                                                                    ['model' => $job, 'folder' => 'job', 'optionalFolder' => 'optionalJob']
                                                                )
                                                        </div>
