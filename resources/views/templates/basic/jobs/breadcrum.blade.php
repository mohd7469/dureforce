...
<div class="breadcrumb" >
    ...
    <a class="breadcrumb__step  {{Route::is('buyer.job.all.proposals') ? 'breadcrumb__step--active':''}} ancortag-class" href="{{route('buyer.job.all.proposals',$job_uuid)}}">Review Proposals ({{getNumberOfPropsals($job_uuid)}})</a>
