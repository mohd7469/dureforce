       ...
       <div class="card-body text-success div-background" >
         ...
         <div class="row section-end-line text-dark pt-3 pb-1 d-none " id="by_project_section">
             ...
             <div class="col-md-3 col-lg-3 col-xl-3 col-sm-6 col-xs-6">
               ...
               <input type="date" class="form-control" name="project_start_date" value="" min="1970-01-01">
               </div>
            </div>
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 col-sm-6 col-xs-6" >
               ...
               <div class="input-group mb-3">
               <input type="date" class="form-control" name="project_end_date" value=""  min="1970-01-01">
               </div>
            </div>
               ...
               <div class=" milestones" id="milestiones">
                  ...
                  <div class="row" id="milestone1">
                     ...
                     <div class="col-md-2 col-lg-2 col-xl-2 col-sm-4 col-xs-4">
                        ...
                        <div class="input-group mb-3">
                        <input type="date" class="form-control" name="milestones[1][start_date]" value="" id="milestones.1.start_date" min="1970-01-01">
                        </div>
                     </div>
                     ...
                     <div class="col-md-2 col-lg-2 col-xl-2 col-sm-4 col-xs-4">
                        ...
                        <div class="input-group mb-3">
                        <input type="date" class="form-control" name="milestones[1][end_date]" value=""  id="milestones.1.end_date" min="1970-01-01">
                        </div>
                     </div>
