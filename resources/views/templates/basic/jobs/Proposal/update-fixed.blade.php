       ...
       <div class="card-body text-success div-background" >
          ...
          <div class="row section-end-line text-dark pt-3 pb-1">
            ...
            <div class="form-check">
               <input class="form-check-input" type="radio" name="bid_type" id="milestone" onclick="byMilestone()" value="milestone" @if($proposal->bid_type =='Milestone') checked @endif >
             ...
             <div class="form-check">
               <input class="form-check-input" type="radio" name="bid_type" id="project" onclick="byProject()" value="by_project" @if($proposal->bid_type =='Project') checked @endif >
         ...
         <div class="row section-end-line text-dark pt-3 pb-1 d-none " id="by_project_section">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 col-sm-6 col-xs-6" >
               ...
               <div class="input-group mb-3">
               <input type="date" class="form-control" name="project_end_date" value="{{ $proposal->project_end_date }}"  min="1900-01-01" max="2099-12-31">
               </div>
            </div>
               ...
               @foreach($proposal->milestone as $miles)
                  <div class="row" id="milestone1">
                     <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12">
                        ...
                        <input type="text" name="milestones[1][description]" maxlength="255" value="{{$miles->description ?? ''}}" class="form-control" id="milestones.1.description">
                     </div>
                     ...
                     <div class="col-md-2 col-lg-2 col-xl-2 col-sm-4 col-xs-4">
                        ...
                        <div class="input-group mb-3">
                        <input type="date" class="form-control" name="milestones[1][start_date]" value="{{$miles->start_date ?? ''}}" id="milestones.1.start_date" min="1900-01-01" max="2099-12-31">
                        </div>
                     </div>
                     ...
                     <div class="col-md-2 col-lg-2 col-xl-2 col-sm-4 col-xs-4">
                        ...
                        <div class="input-group mb-3">
                        <input type="date" class="form-control" name="milestones[1][end_date]" value="{{$miles->end_date ?? ''}}"  id="milestones.1.end_date" min="1900-01-01" max="2099-12-31">
                        </div>
                     </div>
                     ...
                     <div class="col-md-2 col-lg-2 col-xl-2 col-sm-4 col-xs-4">
                        ...
                        <div class="input-group">
                           <input type="number" name="milestones[1][amount]" step="any" maxlength="255" value="{{$miles->amount ?? ''}}" class="form-control milestones_amount"  id="milestones.1.amount" oninput="this.value = Math.abs(this.value)">
            ...
            <div class="row section-end-line">
               ...
               <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12">
                     <div class="form-group pt-3">
                        ...
                        <div class="input-group">
                           <input type="number" step="any" class="form-control" id="total_milestones_amount" value="{{ $proposal->fixed_bid_amount }}" name="total_project_price" readonly oninput="this.value = Math.abs(this.value)">
                           <span class="input-group-text float-end">$</span>
                        </div>
               ...
               <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12 bg-default">
                  ...
                  <div class="form-group pt-3">
                     ...
                     <span class="pt-2 text-dark" id="system_fee">${{ round(($proposal->fixed_bid_amount*$service_fee_percentage), 2) }}</span>
                  </div>
               ...
               <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12">
                  <div class="form-group pt-3">
                     ...
                     <small  class="form-text text-muted">The estimated amount you'll receive after service fees</small>
                        ...
                        <div class="input-group">
                           <input type="number" class="form-control"  aria-describedby="emailHelp " name="amount_receive" value="{{ $proposal->amount_receive }}" step="any" readonly id="milestones_amount_receive">
                           <span class="input-group-text float-end">$</span>
                        </div>
                  ...
                  <div class="form-group pt-3">
                     ...
                     <select name="delivery_mode_id" id="delivery_mode_id" class="form-control">
                        ...
                        @foreach ($delivery_modes as $mode)
                           <option value="{{$mode->id}}"  {{ $mode->id == @$proposal->delivery_mode_id ? 'selected' : '' }}>{{$mode->title}}</option>
