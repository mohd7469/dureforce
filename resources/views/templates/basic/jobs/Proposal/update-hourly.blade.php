         ...
         <div class="row section-end-line">
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12">
                  <div class="form-group pt-3">
                     ...
                     <div class="input-group">
                        <input type="number" name="hourly_bid_rate" class="form-control" step="any" id="hourly_bid_rate"  min="1" value="{{ $proposal->hourly_bid_rate }}">
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12">
               <div class="form-group pt-3 ">
                  ...
                  <div class="input-group">
                     <input type="number"  class="form-control" id="amount_receive" aria-describedby="emailHelp" name="amount_receive" value="{{ $proposal->amount_receive }}" step="any" readonly>
                     <span class="input-group-text float-end">$</span>
                  </div>
                  ...
                  <div class="form-group pt-3">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm12 col-xs-12">
                           ...
                           <input type="integer" step="any" class="form-control" id="end_hour_limit" value="{{ $proposal->end_hour_limit }}" name="end_hour_limit">
