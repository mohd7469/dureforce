                                            ...
                                            <div class="item-card-wrapper border-0 p-0 list-view">
                                                <div class="item-card">
                                                    <div class="item-card-thumb">
                                                        <img src="{{ getImage('assets/images/job/' . $jobBiding->job->image, imagePath()['job']['size']) }}"
                                                        ...
                                                        <div class="item-card-content-top">
                                                            <div class="left">
                                                                <div class="author-thumb">
                                                                    <img src="{{ userDefaultImage(imagePath()['profile']['user']['path'] . '/' . $jobBiding->user->image, 'profile_image') }}"
                                                                        alt="{{ __($jobBiding->user->username) }}">
                                                                </div>
                                                                <div class="author-content">
                                                                    <h5 class="name"><a
                                                                            href="{{ route('profile', $jobBiding->user->username) }}">{{ __($jobBiding->user->username) }}</a>
                                                                        <span class="level-text">
                                                                            {{ __(@$jobBiding->user->rank->level) }}</span>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                            <div class="right d-flex flex-wrap align-items-center">
                                                                <div class="item-amount">
                                                                    {{ $general->cur_sym }}{{ showAmount($jobBiding->price) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <h3 class="item-card-title"><a
                                                                href="javascript:void(0)">{{ __($jobBiding->title) }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="sidebar">
                                            <div class="widget custom-widget mb-30">
                                                ...
                                                <ul class="details-list">
                                                    <li><span>@lang('Biding Price') :</span>
                                                        <span>{{ $general->cur_sym }}{{ getAmount($jobBiding->price) }}</span>
                                                    </li>
                                                ...
                                                <div
                                                    ...
                                                    <div class="right">
                                                        <h4 class="title">{{ $general->cur_sym }}<span
                                                                id="paymentPrice">{{ getAmount($jobBiding->price) }}</span>
                                                        </h4>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="item-card">
                                                            ...
                                                            <div class="item-card-content">
                                                                <div class="item-card-content-top">
                                                                    <div class="left">
                                                                        <div class="author-thumb">
                                                                            <img src="{{ getImage(imagePath()['profile']['user']['path'] . '/' . $other->user->image, 'profile_image') }}"
                                                                                alt="@lang('author')">
                                                                        </div>
                                                                        <div class="author-content">
                                                                            <h5 class="name"><a
