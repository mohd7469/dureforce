                                            ...
                                            @foreach ($subCategorys as $subCategory)
                                                <div class="swiper-slide">
                                                    <div class="category-item-box">
                                                        <a
                                                            href="{{ route('job.sub.category', [slug($subCategory->name), $subCategory->id]) }}">
                                                            <img src="{{ getImage(imagePath()['subcategory']['path'] . '/' . $subCategory->image, imagePath()['subcategory']['size']) }}"
                                                                alt="@lang('sub category')">
                                                            <div class="category-item-content">
                                                                <h4 class="title text-white">{{ __($subCategory->name) }}
                                                                </h4>
                                                            </div>
                                                        </a>
                                                    </div>
                                    ...
                                    <div class="item-wrapper d-flex flex-wrap justify-content-between align-items-center">
                                        <div class="item-wrapper-left d-flex flex-wrap align-items-center">
                                            <div class="item-value">
                                                <span>@lang('Showing page'):&nbsp <span
                                                        class="result">{{ $jobs->firstItem() }} @lang('of')
                                                        {{ $jobs->lastPage() }}</span></span>
                                            </div>
                                        </div>
                                        <ul class="view-btn-list">
                                            <li class="active"><button type="button"
                                                    class="grid-view-btn list-btn"><i
                                                        class="lab la-buromobelexperte"></i></button></li>
                                            <li><button type="button" class="list-view-btn list-btn"><i
                                                            ...
                                                            <div class="right mb-10">
                                                                <div class="order-btn">
                                                                    <a href="{{ route('job.details', [slug($job->title), encrypt($job->id)]) }}"
                                                                        class="btn--base"><i
                                                                            class="las la-shopping-cart"></i> @lang('Bid
                                                                        Now')</a>
                                                                </div>
                                                            </div>
                                                        </div>
