<div class="col-xl-3 col-lg-3 mb-30">
    <div class="sidebar">
            ...
            <div class="widget mb-30">
                ...
                <ul class="category-list">
                    @foreach(\App\Models\Category::getByType($type_id) as $category)
                        <li>
                            <a href="{{route('service.category', [slug($category->name),$category->id])}}">{{__($category->name)}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
        ...
        <form action="{{route('home.search.item')}}" method="GET">
            ...
            <div class="widget mb-30">
                ...
                @foreach($features as $feature)
                    <div class="form-group custom-check-group">
                        <input type="checkbox" id="{{$feature->id}}.'f'" name="feature[]" value="{{$feature->id}}"
        ...
        @if(!empty($type_id))
                    <h3 class="widget-title">@lang('Key Words')</h3>
            @include('templates.basic.partials._tag_cloud',['tag_type_id'=>$type_id])
