            ...
            <div class="card">
                <div class="top-card-header ">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-tabs="tabs">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="true" data-bs-toggle="tab" href="#Search_tab">Active</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#Invited_Freelancers_tab">Archived</a>
                        </li>
                    </ul>
                </div>
                <form class="card-body tab-content">
                    <div class="tab-pane active" id="Search_tab">
                        <div class="card-text">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <span class="card-main-headind">eCommerce Website Design</span>
                                    <div class="row">
                                        <div class="col-md-2"> 
                        ...
                        <div class="card-text mt-20">
                            <div class="card">
                                <div class="card-header float-left">
                                    <span class="card-heading">Invitations to interview (1)</span>
                                </div>
                                <div class="card-body">
                                    <span class="card-main-headind">Mobile App Design</span>
                                    <div class="row">
                                        <div class="col-md-2"> 
                                            <p class="card-sub-headind">Received Oct 6, 2022</p>
                                        </div>
                        ...
                        <div class="card-text mt-20">
                            <div class="card">
                                <div class="card-header float-left">
                                    <span class="card-heading"> Submitted Proposals (1)</span>
                                </div>
                                <div class="card-body">
                                    <span class="card-main-headind">Website Rebranding </span>
                                    <div class="row">
                                        <div class="col-md-2"> 
                                            <p class="card-sub-headind">Received Oct 6, 2022</p>
                                        </div>
