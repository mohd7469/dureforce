                                                            ...
                                                            <div class="left">
                                                                ...
                                                                <div class="author-content">
                                                                    ...
                                                                    <div class="ratings">
                                                                        ...
                                                                        <span
                                                                            class="rating me-2">{{ __($service->rating) }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="left">
                                                                        <div class="form-group custom-check-group">
                                                                            <input type="checkbox" id="{{ $key }}"
                                                                                ...
                                                                                class="extraService">
                                                                            <label
                                                                                for="{{ $key }}">{{ __($extra->title) }}</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="right">
                                                                        <span
                                                                            class="value">{{ $general->cur_sym }}{{ getAmount($extra->price) }}</span>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="right">
                                                        <h4 class="title">{{ $general->cur_sym }}<span
                                                                id="paymentPrice">{{ getAmount($service->price) }}</span>
                                                        </h4>
                                                    </div>
                                                </div>
                                                @if ($coupon)
                                                    <form class="coupon-form mt-20">
                                                        ...
                                                        <button type="button" class="coupon-form-btn" id="couponApply"><i
