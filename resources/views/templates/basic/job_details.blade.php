                                                                ...
                                                                <div class="item-details-tag p-0 m-0 border-0">
                                                                    <ul class="tags-wrapper">
                                                                        ...
                                                                        @foreach ($job->skill as $skill)
                                                                            <li><a
                                                                                    href="javascript:void(0)">{{ __($skill) }}</a>
                                                                            </li>
                                                                        @endforeach
                                                                    </ul>
                                                                </div>
                                            ...
                                            <div class="product-tab mt-40">
                                                <nav>
                                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                        ...
                                                        <button class="nav-link" id="req-tab" data-bs-toggle="tab"
                                                            data-bs-target="#req" type="button" role="tab"
                                                            aria-controls="req"
                                                            aria-selected="false">@lang('Requirements')</button>

                                                        <button class="nav-link" id="bids-tab" data-bs-toggle="tab"
                                                            data-bs-target="#bids" type="button" role="tab"
                                                            aria-controls="bids"
                                                            aria-selected="false">@lang('Bids')</button>
                                                                ...
                                                                <div class="card custom--card mt-20">
                                                                    <div class="card-body">
                                                                        <div class="card-form-wrapper">
                                                                            <form
                                                                                action="{{ route('user.job.biding.store') }}"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="col-xl-6 form-group">
                                                                                        <label>@lang('Any One Can
                                                                                            Order')*</label>
                                                                                        <select
                                                                                            class="form-control bg--gray"
                                                                                            name="order_type" required="">
                                                                                            <option value="1">@lang('Yes')
                                                                                            </option>
                                                                                            <option value="2">@lang('No')
                                                                                            </option>
                                                                                        </select>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-xl-12 form-group">
                                                                                        ...
                                                                                        <textarea class="form-control bg--gray" name="description" placeholder="@lang('Description')" rows="8"
                                                                                            required="">{{ old('description') }}</textarea>
                                                                                    </div>
                                                                                    <div class="col-xl-12 form-group">
                                                                                        <button type="submit"
                                                                                            class="submit-btn w-100">@lang('BID
                                                                                            NOW')</button>
                                                                                    </div>
                                                                                </div>
                                                                            </form>
                                                                    ...
                                                                    <div class="item-card">
                                                                        <div class="item-card-content">
                                                                            <div class="item-card-content-top">
                                                                                <div
                                                                                    class="item-top-wrapper d-flex flex-wrap align-items-center justify-content-between">
                                                                                    <h3 class="item-card-title">
                                                                                        {{ __($biding->title) }}</h3>
                                                                                    <div class="right">
                                                                                        <div class="item-amount">
                                                                                            {{ $general->cur_sym }}{{ showAmount($biding->price) }}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <p>{{ __($biding->description) }}</p>
                                                                                <div
                                                                                    class="item-footer-wrapper d-flex flex-wrap align-items-center justify-content-between">
                                                                                    <div class="left">
                                                                                        <div class="author-thumb">
                                                                                            <img src="{{ userDefaultImage(imagePath()['profile']['user']['path'] . '/' . $biding->user->image, 'profile_image') }}"
                                                                                                alt="@lang('author')">
                                                                                        </div>
                                                                                        <div class="author-content">
                                                                                            <h5 class="name"><a
                                                                                                    href="{{ route('profile', $biding->user->username) }}">{{ __($biding->user->username) }}</a>
                                                                                                <span
                                                                                                    class="level-text">{{ __(@$biding->user->rank->level) }}</span>
                                                                                            </h5>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="right">
                                                                                        <div class="order-btn">
                                                                                            <a href="{{ route('user.job.biding.order', [slug($biding->title), encrypt($biding->id)]) }}"
                                                                                                class="btn--base"><i
                                                            ...
                                                            @if ($jobBidings->total() > 5)
                                                                <div class="view-more-btn text-center mt-4">
                                                                    <a href="javascript:void(0)"
                                                                        class="btn--base jobBidingMore" data-page="2"
                                                                        data-link="{{ route('job.details', [slug($job->title), encrypt($job->id)]) }}?page=">
                                                                        @lang('View More')</a>
                                                                </div>
                                                            @endif
                                                        @endif
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <h3 class="reviews-title">
                                                                        {{ $job->commentCount->count() }} @lang('comments')
                                                                    </h3>
                                        ...
                                        <div class="sidebar">
                                            <div class="widget custom-widget mb-30">
                                                ...
                                                <ul class="details-list">
                                                    <li><span>@lang('Delivery Time')</span> <span>{{ $job->delivery_time }}
                                                            @lang('Days')</span></li>
                                                    <li><span>@lang('Budget')</span> <span>{{ showAmount($job->amount) }}
                                                            {{ $general->cur_text }}</span></li>
                                                </ul>
                                            </div>
                                                ...
                                                <div class="profile-widget">
                                                    <div class="profile-widget-header">
                                                        <div class="profile-widget-thumb">
                                                            <img src="{{ userDefaultImage(imagePath()['profile']['user_bg']['path'] . '/' . $job->user->bg_image, 'background_image') }}"
                                                                alt="@lang('User bg image')">
                                                        </div>
                                                        <div class="profile-widget-author">
                                                            <div class="thumb">
                                                                <img src="{{ userDefaultImage(imagePath()['profile']['user']['path'] . '/' . $job->user->image, 'profile_image') }}"
                                                                    alt="{{ __($job->user->username) }}">
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="name">
                                                                    <a
                                                                        href="{{ route('profile', $job->user->username) }}">{{ __($job->user->username) }}</a>
                                                                </h4>
                                                                <span
                                                                    class="designation">{{ __(@$job->user->designation) }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="item-card">
                                                            ...
                                                            <div class="item-card-content">
                                                                <div class="item-card-content-top">
                                                                    ...
                                                                    <div class="right">
                                                                        <div class="item-amount">
                                                                            {{ __($general->cur_sym) }}{{ getAmount($other->price) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
