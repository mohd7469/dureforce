...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-7 col-md-7">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.sub.attribute.update',$subAttribute->id)}}" method="POST">
                        @csrf
                        <div class="row">
                        {{-- Module --}}
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <select class="form-control" name="skill_category" >
                                    ...
                                    @foreach($SkillCategorys as $SkillCategory)
                                        <option value="{{ ($SkillCategory->id) }}" {{ $SkillCategory->id == $subAttribute->skill_category_id ? 'selected' : '' }}>{{__($SkillCategory->name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="title" value="{{ $subAttribute->title }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <select class="form-control" name="module" >
                                    ...
                                    @foreach($modules as $module)
                                        <option value="{{ ($module->id) }}" {{ $module->id == $subAttribute->module_id ? 'selected' : '' }}>{{__($module->name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
