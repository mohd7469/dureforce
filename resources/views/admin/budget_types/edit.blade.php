...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-7 col-md-7">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.budget.type.update',$budgetType->id)}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="title" value="{{$budgetType->title}}" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Slug')<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="slug" value="{{$budgetType->slug}}" >
                                </div>
                            </div>
                            {{-- Module --}}
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                ...
                                <select class="form-control" name="module" >
                                    ...
                                    @foreach($modules as $module)
                                        <option value="{{ ($module->id) }}" {{ $module->id == $budgetType->module_id ? 'selected' : '' }}>{{__($module->name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
