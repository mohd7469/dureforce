...
<div class="row">
    <div class="col-lg-12">
        <a href="{{ route('admin.techlogo.create') }}" class="btn btn-primary btn-sm float-right">Create Technology Logo</a>
    </div>
</div>
<br>
<div class="row">
...
<div class="modal fade" id="inactiveBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.techlogo.inactiveBy') }}" method="POST">
                @csrf
                @method('POST')
...
<div class="modal fade" id="activeBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.techlogo.activeBy') }}" method="POST">
                @csrf
                @method('POST')
                <input type="hidden" name="id">
                <div class="modal-body">
