...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-7 col-md-7">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.deliver.update',$deliver->id)}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="title" value="{{$deliver->title}}" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Title')<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="slug" value="{{$deliver->slug}}" >
                                </div>
                            </div>
                        </div>
