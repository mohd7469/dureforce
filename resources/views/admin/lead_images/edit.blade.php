...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-7 col-md-7">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.leadImages.update',$banner->id)}}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">@lang('Upload Lead image') <span class="text-danger">*</span></label>
...
<script>
    ...
    function fetchSubCategories(category)
    {
        $.ajax({
            type:"GET",
            url:"{{route('admin.leadImages.category')}}",
