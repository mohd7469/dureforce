...
<div class="row">
    <div class="col-lg-12">
        ...
        <a href="{{ route('admin.type.create') }} " class="btn btn-primary btn-sm float-right">Create Job Type</a>
    </div>
</div>
<br>
<div class="row">
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Title')">
                                <div class="user">
                                    <span class="name">{{$type->title}}</span>
                                </div>
                            </td>
                            <td data-label="@lang('Slug')">
                                <div class="user">
                                    <span class="name">{{$type->slug}}</span>
                                </div>
                            </td>
                            ...
                            <td data-label="@lang('Action')">
                                    ...
                                    <a  href="{{route('admin.type.edit', $type->id)}}" class="icon-btn btn--success ml-1  editbtn-c" id="" data-toggle="tooltip1" title="" data-original-title="@lang('InActive')" data-id="">
                                        <i class="las la-edit"></i>
                                    </a>
                               
                                     {{-- <a href="#" class="delete" data-confirm="Are you sure to delete this item?">Delete</a>  --}}
                               
                                     <a type="submit"  href="{{route('admin.type.delete', $type->id)}}" class="icon-btn btn--danger ml-1 editbtn-c delete disabled" id="" data-toggle="tooltip1" title="" data-original-title="@lang('active')" data-id="" data-confirm="Are you sure to delete this item?"> 
...
<div class="modal fade" id="inactiveBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.type.inactive') }}" method="POST">
                @csrf
                @method('POST')
...
<div class="modal fade" id="activeBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.type.active') }}" method="POST">
                @csrf
                @method('POST')
                <input type="hidden" name="id">
                <div class="modal-body">
