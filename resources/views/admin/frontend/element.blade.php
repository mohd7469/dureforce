                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <div class="p-2">
                                                            ...
                                                            <input required="" type="text" name="banner_heading"
                                                                   maxlength="255"
                                                                   value="{{@$data->data_values->banner_heading}}"
                                                                   class="form-control"
                                                                   placeholder="@lang("Enter  Banner Heading")"
                                                                   required="">
                                                            ...
                                                            <textarea required="" type="text" name="banner_detail"
                                                                      ...
                                                                      required="">{{@$data->data_values->banner_detail}}
                                                        </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <select class="form-control" name="{{ @$selectName }}">
                                                    @foreach($content->options as $selectItemKey => $selectOption)
                                                        <option value="{{ $selectItemKey }}"
                                                                @if(@$data->data_values->$selectName == $selectItemKey) selected @endif>{{ __($selectOption) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
