                            ...
                            <form class="contact-form" method="post" action="">
                                ...
                                <div class="row justify-content-center mb-10-none">
                                    <div class="col-lg-6 col-md-6 form-group">
                                        <input type="text" name="name" value="@if(auth()->user()) {{ auth()->user()->fullname }} @else {{ old('name') }} @endif" @if(auth()->user()) readonly @endif class="form--control" placeholder="@lang('Enter name')" required="">
                                    </div>
                                    <div class="col-lg-6 col-md-6 form-group">
