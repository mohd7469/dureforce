                                        ...
                                        <div class="item-details-area">
                                            <div class="item-details-box">
                                                <div class="item-details-thumb-area">
                                                    ...
                                                    {{-- slider area --}}
                                                    @include($activeTemplate.'partials._banner',['model'=>$service,'folder'=>'service',
                                                    ...
                                                    <div class="item-details-content">
                                                        <h1 class="title">{{ __($service->title) }}</h1>
                                                        ...
                                                        <div class="product-reviews-content">
                                                            <div class="item-review-widget-wrapper">
                                                                <div class="left">
                                                                    ...
                                                                    <span
                                                                        class="sub-title text-white">{{ $service->reviewCount->count() }}
                                                                        @lang('reviews')</span>
                                                                </div>
                                                                <div class="right">
                                                                    <ul class="list">
                                                                ...
                                                                <div class="comment-form-area mb-40">
                                                                    <form class="comment-form"
                                                                        ...
                                                                        <textarea class="form-control h-auto"
                                                                            ...
                                                                            name="review" rows="8" required=""></textarea>
                                                                        <button type="submit"
                                                                    ...
                                                                    @if ($reviews->total() > 7)
                                                                        <div class="view-more-btn text-center mt-4">
                                                                            <a href="javascript:void(0)"
                                                                                ...
                                                                                data-link="{{ route('service.details', [slug($service->title), encrypt($service->id)]) }}?page=">
                                                                                @lang('View More')</a>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            ...
                                                            <div class="comment-form-area mb-40">
                                                                <form class="comment-form" method="POST"
                                                                    ...
                                                                    <textarea class="form-control h-auto" name="comment"
                                                                        placeholder="@lang('Write Comment')" rows="8"
                                                                        required=""></textarea>
                                                                    <button type="submit"
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <ul class="comment-list" id="commentShow">
                                                                        @foreach ($comments as $comment)
                                                                            <li class="comment-container d-flex flex-wrap">
                                                                                <div class="comment-avatar">
                                                                                    <img src="{{ !empty($comment->user->image)? userDefaultImage(imagePath()['profile']['user']['path'] . '/' . $comment->user->image, 'profile_image'): getImage('assets/images/default.png') }}"
                                                                                        alt="@lang('client')">
                                                                                </div>
                                                                                <div class="comment-box">
                                                                                    <div
                                                                            ...
                                                                            @foreach ($comment->commentReply as $replyComment)
                                                                                <li
                                                                                    ...
                                                                                    <div class="comment-avatar">
                                                                                        <img src="{{ !empty($replyComment->user->image)? userDefaultImage(imagePath()['profile']['user']['path'] . '/' . $replyComment->user->image, 'profile_image'): getImage('assets/images/default.png') }}"
                                                                                            alt="@lang('client')">
                                                                                    </div>
                                                                                    <div class="comment-box">
                                                                                        <div
                                            ...
                                            <div class="widget custom-widget mb-30">
                                                ...
                                                <ul class="details-list">
                                                    <li><span>@lang('Delivery Time')</span>
                                                        <span>{{ __($service->delivery_time) }} @lang('Days')</span>
                                                    </li>
                                                ...
                                                <div class="widget-btn mt-20">
                                                    ...
                                                    @guest
                                                        <a href="{{ route('user.login') }}" data-bs-toggle="modal"
                                                            data-bs-target="#depoModal" class="btn--base w-100">@lang('Contact
                                                            Now')</a>
                                                    @endguest
                                                </div>
                                            </div>
                                                ...
                                                <div class="profile-widget">
                                                    <div class="profile-widget-header">
                                                        <div class="profile-widget-thumb">
                                                            <img src="{{ !empty($service->user->bg_image)? userDefaultImage(imagePath()['profile']['user_bg']['path'] . '/' . $service->user->bg_image, 'background_image'): getImage('assets/images/default.png') }}"
                                                                alt="@lang('User image')">
                                                        </div>
                                                                ...
                                                                <div class="item-card-content-top">
                                                                    ...
                                                                    <div class="right">
                                                                        <div class="item-amount">
                                                                            {{ __($general->cur_sym) }}{{ showAmount($other->price) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
