                                ...
                                @forelse($bookings as $booking)
                                    <tr @if ($loop->odd) class="table-light" @endif>
                                        ...
                                        <td data-label="@lang('Seller')">
                                            ...
                                            <span class="small">
                                                <a
                                                    href="{{ !empty($booking->service->user_id) ? route('admin.users.detail', $booking->service->user_id) : '#' }}"><span>@</span>{{ @$booking->service->user->username }}</a>
                                            </span>
                                        </td>

                                        <td data-label="@lang('Order Number')"><span
                                                class="font-weight-bold">{{ $booking->order_number }}</span></td>
                                        <td data-label="@lang('Delivery Date')">
                                            ...
                                            <br>
                                            {{ diffforhumans($booking->created_at->addDays($booking->service->delivery_time ?? 5)) }}
                                        </td>

                                        <td data-label="@lang('Service Price')">
                                            <span
                                                class="font-weight-bold">{{ $general->cur_sym }}{{ getAmount($booking->service->price ?? 0) }}</span>
                                        </td>
                                        ...
                                        <td data-label="@lang('Discount')">
                                            @if ($booking->discount != 0)
                                                <span
                                                    class="font-weight-bold">{{ $general->cur_sym }}{{ getAmount($booking->discount ?? 0) }}</span>
                                            @else
                                        ...
                                        <td data-label="@lang('Amount')">
                                            <span
                                                class="font-weight-bold">{{ $general->cur_sym }}{{ getAmount($booking->amount ?? 0) }}</span>
                                        </td>
...
@push('breadcrumb-plugins')
    <form
        action="{{ route('admin.booking.service.search',$scope ??str_replace('admin.booking.service.','',request()->route()->getName())) }}"
