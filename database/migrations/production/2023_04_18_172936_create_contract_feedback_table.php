...
class CreateContractFeedbackTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('contract_feedback', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('reason_end_contract_nr_id')->nullable();
            ...
            $table->foreign('reason_end_contract_id')->references('id')->on('roles');
            $table->foreign('reason_end_contract_nr_id')->references('id')->on('roles');
